...
public interface AddressMapperInterface {
    ...
    default void validateAddressFields(@MappingTarget AddressEntity addressEntity, PatchAddressInputDTO addressDTO) {
        ...
        if (addressDTO.getContactName() == null) addressDTO.setContactName(addressEntity.getContactName());
        if (addressDTO.getContactPhone() == null) addressDTO.setContactPhone(addressEntity.getContactPhone());
